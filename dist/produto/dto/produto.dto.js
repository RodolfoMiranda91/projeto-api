...
__decorate([
    (0, class_validator_1.IsArray)({ message: "Medida não pode ser vazio" }),
    __metadata("design:type", Array)
], CriaProdutoDTO.prototype, "medidas", void 0);
__decorate([
    (0, class_validator_1.IsArray)({ message: "Cor não pode ser vazio" }),
    __metadata("design:type", Array)
], CriaProdutoDTO.prototype, "cor", void 0);
__decorate([
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)({ message: "Marca não pode ser vazio" }),
    __metadata("design:type", String)
